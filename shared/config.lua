...
-- Extra ped models to force into the spawn/model lists when a pack uses an unusual format.
Config.ServerPeds = {}

-- Folder/resource path names that should be treated as ped packs during the server scan.
...
-- Resource subfolders scanned for .ymt files.
Config.PedScanDirectories = {
	'stream',
	'data_files',
	'data',
	'metapeds',
